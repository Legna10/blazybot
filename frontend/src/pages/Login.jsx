...
const Login = () => {
  ...
  useEffect(() => {
    login()
      .catch((err) => console.error("Login init failed:", err));

    socket.on("connect", () => 
      setStatus("Connected to server, waiting for QR..."));
    socket.on("qr", (qrCode) => {
      setQr(qrCode);
    ...
    socket.on("authenticated", () => 
      setStatus("Authenticated successfully! Waiting for WhatsApp to be ready...!"));
